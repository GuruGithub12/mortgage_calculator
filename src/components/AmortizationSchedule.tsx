        ...
        <div className="flex gap-3 flex-wrap">
          <button
            ...
            className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 ${
              viewMode === 'yearly'
                ? 'bg-gradient-to-r from-emerald-500 to-sky-500 text-white shadow-lg shadow-emerald-500/40 scale-105'
            ...
            <div key={yearData.year} className="border border-white/10 rounded-2xl overflow-hidden backdrop-blur-sm bg-white/5 hover:bg-white/10 transition-all duration-300">
              ...
              >
                <div className="flex items-center gap-4">
                  <span className={`text-emerald-400 transition-transform duration-300 ${expandedYears.has(yearData.year) ? 'rotate-90' : ''}`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
